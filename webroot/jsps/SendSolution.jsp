...
-->
    ...
    <jsp:include page="Header.jsp"></jsp:include>
       ...
       %>
					  ...
					  <c:if test="${not empty QueryAtInfo}">
                      <c:forEach var="QueryAtInfo" items="${QueryAtInfo}">
                        <tr>

                  <td width="85"><span>QueryId</span><br></td>
              <td width="286"><label>
                            <input type="text" name="qid" size="48" value="${QueryAtInfo.qid }" readonly="readonly" />
                          </label><br></td>
                        </tr>
              ...
              <td width="286"><label>
                            <input type="text" name="from" size="48" value="${QueryAtInfo.fname }" readonly="readonly" />
                          </label><br></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td><label>
                            <textarea name="query"  cols="45" rows="5"  readonly="readonly">${QueryAtInfo.query }</textarea>
                          </label><br></td>
                        </tr>
                        <tr>
                          <td><span class="">Send Date</span><br></td>
                          <td><input type="text" name="sdate"   readonly="readonly" value="${QueryAtInfo.date }"/><br></td>
                        </tr>
                        <tr>
