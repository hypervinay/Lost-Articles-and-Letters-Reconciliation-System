...
<html>
 ...
 <jsp:include page="../jsps/Header.jsp"></jsp:include>
  ...
  <table align="center" border="1" bgcolor="" width="90%" cellpadding="10">
   ...
   <c:if test="${not empty MaintainReceiver}">
   
   <c:forEach var="ReceiverInfo" items="${MaintainReceiver}">
 ...
 %>
  ...
  <a href="./ViewPostInfoAction">Back</a>
  ...
  <a href="./MaintainLostPostAction">Back</a>
  <%
  } else if(session.getAttribute("role").equals("postman"))
  {
  %>

  <a href="./GetPostmanPostsAction?login=<%=(String)session.getAttribute("user")%>">Back</a>
  <%
  }
   %>
