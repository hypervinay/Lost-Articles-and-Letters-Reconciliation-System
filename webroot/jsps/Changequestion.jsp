...
font-size:8pt
   ...
   <center>
                      <span class=Title><h3>ChangeQuestion Form  </h3></span>
      </center>
    <form action="<%=request.getContextPath()+"/ChangequestionAction"%>" method="post" name="register" onsubmit="return validator();">
                      ...
                      <tr>
                        <td><table width="380px" border="0" align="center">
                              <tr>
                                ...
                                <td width="269">
                                  <input type="text" name="username" value="${sessionScope.user }" readonly="readonly" />                                </td>
                              </tr>
                              <tr>
