...
window.location.href='http://'+host+':'+port+'/LostPost/ChekUserAction?userName='+userName+"&page=./jsps/EmployeeRegister.jsp";
...
font-size:8pt
		...
		<jsp:include page="Header.jsp"></jsp:include>
		   ...
		   <h3><div align="center"><span class=subHead><br><font color="Orang">Employee Register Form</font> </span></div></h3>
<form action="./AdminRegisterAction" method="post" name="register" onSubmit="return validate()">
...
<tr>
    <td><pre><span class=Title>  SelectRole</span></pre></td>
...
<tr>
 <img alt="See Photo Here" id="previewField" src="<%=request.getContextPath()+"/images/flag.gif"%>" height="150" width="120">
