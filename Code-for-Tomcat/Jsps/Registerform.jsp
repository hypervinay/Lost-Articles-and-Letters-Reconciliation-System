...
window.location.href='http://'+host+':'+port+'/LostPost/ChekUserAction?userName='+userName+"&page=./jsps/Registerform.jsp";
...
<tr></tr><tr></tr>
 <tr>
    ...
    <%if(request.getAttribute("status1")!=null)                                      
     out.print(request.getAttribute("status1"));    %></span></td>
</tr>
<tr>
