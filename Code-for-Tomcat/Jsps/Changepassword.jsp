...
<jsp:include page="Header.jsp"></jsp:include>
      ...
      <center><span class=Title><h3><font color="ertyashblue">Change Password Form</font> </h3></span></center>
		...
		<form id="form3" name="newedesignation" method="post" action="<%=request.getContextPath()+"/ChangePasswordAction"%>" onsubmit="return validator();">
			<table border="0" align="center">
				<tr>
					<td><span class=Title>
				<font color="bujjigadu"> Login Name</font>
					</span></td>
					<td>
				...
				<tr>
					<td><span class=Title>
					<font color="bujjigadu">  Old Password</font>
					</span></td>
					<td>
				...
				<tr>
					<td><span class=Title>
					<font color="bujjigadu">  New Password</font>
					</span></td>
					<td>
