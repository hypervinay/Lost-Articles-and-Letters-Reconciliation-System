...
<html xmlns="http://www.w3.org/1999/xhtml"><head id="ctl00_header">
  ...
  <jsp:include page="Header.jsp"></jsp:include>
   ...
   <tr><th><b>POSTID</b></th><th><b>POST ITEM</b></th><th><b>POSTLOCATION</b></th><th><b>POSTDATE</b></th><th><b>DELIVERYDATE</b></th><th><b>ADDRESS INFO</b></th><th><b>STATUS</b></th>
    </tr>
   ...
   <tr>
      ...
      <td><a href="./GetSenderInfoAction?postid=${PostmanPost.postid }">SenderAddress</a>
       <br/>
        <a href="./GetReceiverInfoAction?postid=${PostmanPost.postid }">ReceiverAddress</a>
         </td> 
