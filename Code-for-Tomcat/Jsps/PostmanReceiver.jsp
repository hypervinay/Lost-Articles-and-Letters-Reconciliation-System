...
<html>
 ...
 <jsp:include page="../jsps/Header.jsp"></jsp:include>
  ...
  <table align="center" border="1" bgcolor="" width="90%" cellpadding="10">
   ...
   <c:if test="${not empty PostReceiver}">
   
   <c:forEach var="ReceiverInfo" items="${PostReceiver}">
 ...
 %>
  ...
  <a href="./GetPostmanPostsAction?page=/jsps/SendReport.jsp"">Back</a>
  <%
  }
   %>
 <c:if test="${empty PostReceiver}">
