...
public class UpdateAction extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -269988892416625818L;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       // rb.setStatus(1); 
        ...
        boolean flag=new ProfileMgrDelegate().modifyProfile(rb);
        
        if(flag) 
           target = "./jsps/UpdateProfile.jsp?status=Updation Success"; 
        else  
            target = "./jsps/UpdateProfile.jsp?status=Updation Failed"; 
            }catch(Exception e)
            {
            	e.printStackTrace();
            	}
