...
public class ComplaintResponseAction extends HttpServlet {
...
String path="";
		...
		try{
			...
			if(!complaintInfo.isEmpty()){
				...
				request.setAttribute("ResponseComplaint", complaintInfo);
				
				path=UtilConstants._RESPONSE_COMPLAINT_HOME;			
			}
			else {
